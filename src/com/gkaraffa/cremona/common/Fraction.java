...
public class Fraction extends Object implements Comparable<Object>{
	...
	public Fraction add(Fraction incrementor){
		...
		result = new Fraction((fractionArray[0].getWorkingNumerator() + fractionArray[1].getWorkingNumerator()), fractionArray[0].getWorkingDenominator());
		return (result);
	}
	...
	public int compareTo(Object o){
		...
		else if (fractionArray[0].getWorkingNumerator() < fractionArray[1].getWorkingNumerator()){
			return BEFORE;
		}
		else{
			return AFTER;
